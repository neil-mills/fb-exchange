...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"modules/data.js":[function(require,module,exports) {
"use strict";
...
var getSelectedValue = function getSelectedValue(elm) {
  return elm.options[elm.options.selectedIndex].value;
};

var clearOptions = function clearOptions(elm) {
  Array.from(elm.options).filter(function (o) {
    return o.value !== '';
  }).forEach(function (o) {
    return o.remove();
  });
...
var populateOptions = function populateOptions(elms, options) {
  elms.forEach(function (elm) {
    elm.removeAttribute('disabled');
    var selectedValue = getSelectedValue(elm) || null;
    clearOptions(elm);
...
var filterData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var name, value, filterSelectors, currentIndex, collection, url, _yield$axios$get, data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            value = getSelectedValue(e.target);
            ...
            filterSelectors = Array.from(document.querySelectorAll('[data-filtered="true"]'));
            currentIndex = filterSelectors.findIndex(function (s) {
              return s === e.target;
            });
            filterSelectors.forEach(function (s, i) {
              if (i > currentIndex) {
                clearOptions(s);
          ...
          case 7:
            ...
            if (['brandId', 'collectionId'].includes(name)) {
              _context.next = 10;
              break;
            }
          ...
          case 10:
            collection = name === 'brandId' ? 'brand' : 'collection';
            url = "/api/".concat(collection, "/").concat(value);
            document.querySelectorAll('select').forEach(function (selector) {
              return selector.setAttribute('disabled', 'disabled');
            });
            _context.prev = 13;
            _context.next = 16;
          ...
          case 16:
            ...
            document.querySelectorAll('select[data-control]').forEach(function (selector) {
              return selector.removeAttribute('disabled');
            });
            Object.entries(data).forEach(function (_ref2) {
              ...
              var selectors = document.querySelectorAll("select[name=".concat(key, "]"));
              if (!selectors) return;
...
var addEventHandlers = function addEventHandlers() {
  var dataControllers = document.querySelectorAll('select[data-control]');
  if (!dataControllers) return;
  dataControllers.forEach(function (control) {
    return control.addEventListener('change', filterData);
  });
};

var _default = addEventHandlers;
exports.default = _default;
},{"axios":"../node_modules/axios/index.js","babel-polyfill":"../node_modules/babel-polyfill/lib/index.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
(0, _data.default)();
},{"./sass/styles.scss":"sass/styles.scss","./modules/data":"modules/data.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
